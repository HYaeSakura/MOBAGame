...
namespace MobaCommon.Dto
{
    ...
    public class HeroModel : DogModel
    {
        ...
        public HeroModel(int id, int typeId, int team, double sp, double growSp, int maxHp, int attack, int defense, double attackDistance, string name, int maxMp, SkillModel[] skills)
